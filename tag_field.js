Ext.ux.TagField = function(config) {
    ...
    Ext.ux.TagField.superclass.constructor.call(this, config);
};
 
Ext.extend(Ext.ux.TagField, Ext.form.ComboBox, {
   ...
   * @param {String} value The value to match
   */
  removeValue: function(value, defer)
  {  
  ...
  onBlur: function()
  {
    // examine rawvalue to insert new values if needed
    this.setValue(this.fieldParts());
  ...
  onSelect : function(record, index)
  {
    if(this.fireEvent('beforeselect', this, record, index) !== false){
      this.addValue(record.data[this.displayField]);
      this.collapse();
  ...
  initEvents: function() {
    Ext.ux.TagField.superclass.initEvents.call(this);
    this.el.on('keyup', this.collapseCombo, this);
  },
...
Ext.reg('tagfield', Ext.ux.TagField);
